...
const Navbar = () => {
  const { activeMenu, setActiveMenu, currentColor, isClicked, setIsClicked, handleClick, screenSize, setScreenSize } = useStateContext();
...
// const Navbar = () => {
//   const { activeMenu, setActiveMenu, handleClick, currentColor} = useStateContext();
...
//             <img
//               className="rounded-full w-8 h-8" src={avatar} alt=""
//             />
//             <p>
//               <span className="text-gray-400 text-14">Hi,</span>{' '}
